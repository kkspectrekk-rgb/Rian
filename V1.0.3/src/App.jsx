...
function SettingsView({ hasApiKey, onSaved, notify, onOpenAccount }) {
...
function App() {
  ...
  useEffect(() => {
    getSettings().then((settings) => setHasApiKey(settings.hasApiKey));
    getQuotaStatus().then(setQuota);
    return onQuotaUpdated(setQuota);
  }, []);
  useEffect(() => {
